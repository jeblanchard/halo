...
static void test_address_are_equal(void **state) {
    ...
    ip_v6_address a = {1, 2, 3, 4};
    ip_v6_address b = {1, 2, 3, 4};
...
static void test_get_all_nodes_address(void **state) {
    ...
    bool interface_local_is_correct = addresses_are_equal(get_all_nodes_address(INTERFACE_LOCAL),
                                          all_nodes_address_interface_local);

    bool link_local_is_correct = addresses_are_equal(get_all_nodes_address(LINK_LOCAL),
