...
%define STOP_MODE_ABORT_PAGE_0_CMD_CODE  0x21
%define STOP_MODE_ABORT_PAGE_1_CMD_CODE  0x61
%define START_MODE_ABORT_PAGE_0_CMD_CODE 0x22

%define INTERNAL_LOOPBACK_MODE_CODE 0x02

%define CLEARED_RCR 0
%define TCR_NORMAL_MODE 0

%define NORMAL_AUTO_INIT_4_BYTES 0x58

%define INITIAL_INTERRUPT_MASK 0x0b
